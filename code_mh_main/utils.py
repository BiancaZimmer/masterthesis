...
DATA_DIR_FOLDERS = ['mnist_147', 'mnist_1247', 'mnist_12567'] # , 'mnist_147', 'mnist_1247', 'mnist_12567'   # , 'oct_small_cc', 'oct_cc' # set to [] if you want to use all folders in the DATA_DIR, else give name of folders as list that should be used
...
IMBALANCED = True  # True if your dataset is imbalanced, and you want this to be considered in the loss function
